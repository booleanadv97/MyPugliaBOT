...
def process_message():
  ...
  if intent == "Start":
    ...
    response = "Hello, I can help you find the nearest hotel, recommend a place to enjoy typical Apulian dishes, suggest one of the magical spots in Puglia, provide real-time updates on weather, traffic, and road conditions or simply make your day better with a trivia."
    ...
    response = "Sure, please provide your current location so that I can inform you about current traffic status."
    ...
    if location:
      ...
      if "userrequestattractions" in context:
        ...
        response = "Here's a list of nearby restaurants: \n\n" + build_list_of_places(restaurants)
